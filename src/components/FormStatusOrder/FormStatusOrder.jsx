...
export default function FormStatusOrder() {
  ...
  const customSubmit = async (data) => {
    ...
    try {
      ...
      return toastSuccess(
        <>
          Orden encontrada: <strong>'{orderStatus.id}'</strong>
        </>,
        toastId
      );
    } catch (error) {
  ...
  return (
    <>
      {loadingConfig ? (
        ...
        <>
          <section
            className="formStatusOrderContainer d-flex align-items-center "
            style={{
          ...
          >
            ...
            >
              <h4 className="text-center fw-bold">Estado de orden</h4>
              <div className="">
                <label htmlFor="orderId" className="mb-2">
                  Ingrese el ID de Orden
                </label>
                <input
                  type="text"
                  id="orderId"
              ...
              {orderStatus ? (
                <>
                  ...
                  <div className="fontSM-Custom" id="">
                    ...
                    <p>
                      Estado de orden:{" "}
                      <span className="fw-bold text-capitalize text-decoration-underline">

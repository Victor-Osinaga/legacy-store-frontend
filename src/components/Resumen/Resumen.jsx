        ...
        <section style={{
            ...
            <div style={{
                ...
                >
                            ...
                            <div style={{
                                ...
                                <div className='d-flex flex-column justify-content-center align-items-start'>
                                    ...
                                    <div style={{ fontSize: '.75rem', display: 'flex', flexDirection: 'column', alignItems: 'start', gap: '0rem' }}>
                                        ...
                                        <p className="m-0">Talla: {item.selectedSizeName}, Color: {item.selectedColorName}</p>
                                        {/* <div>
                    ...
                    >
                        <span>
                            Subtotal: ${calcPriceFinal(location.state.datos.resumen.products, 0)}
                        </span>
                        <span>
                            Envio: ${location.state.datos.shipments.cost}
                        </span>
                        <span>
                            Total: ${calcPriceFinal(location.state.datos.resumen.products, location.state.datos.shipments.cost)}
                        </span>
                    </div>
                </div>
                <div
                ...
                >
                    ...
                    <div className='row' data-bs-theme='dark'>
                        ...
                        <div className='col-6 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Apellido</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-12 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Email</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-6 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Codigo de area</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-6 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Telefono</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-12 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Calle</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-6 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Numero</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-6 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Codigo postal</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{
                        ...
                        <div className='col-12 mb-3'>
                            <label className="form-label fw-semibold w-100 d-flex mb-1 fontSM-Custom">Provincia</label>
                            <input
                                type="text"
                                className='form-control fontSM-Custom custom-placeholder'
                                style={{

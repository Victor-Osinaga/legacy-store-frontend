...
function NavBar() {
  ...
  return (
    <nav
      ...
      style={{
        backgroundColor: `${
          configStore?.colors?.secondaryColorStore || "transparent"
        }`,
        color: `${
          configStore?.colors
            ? getTextColor(configStore.colors.secondaryColorStore)
            : "black"
        }`,
      }}
    >
      ...
      >
        ...
        <div className="nav__mainLinksContainer">
          <div
            id="nav__MenuSvgContainer"
            className="nav__MenuSvgContainer"
            onClick={toggleNav}
          >
            <div
              className="nav__burguerIconOpenContainer"
              id="nav__burguerIconOpenContainer"
            >
          ...
          {loading || !configStore ? (
            <div
              className="spinner-grow text-secondary m-auto d-md-block d-none"
              role="status"
            >
            ...
            <ul
              className={
                navVisible
                  ? "nav__mainCategoriasContainer expanded"
            ...
            >
              <div
                id="nav__MenuSvgContainerClose"
                className="nav__MenuSvgContainerClose"
                onClick={toggleNav}
              >
                              ...
                              {sub.categories.map((uniq) => (
                                <div key={uniq.id}>
                                  {navVisible ? (
                                    <Link
                                      onClick={toggleNav}
                                      to={`/category/${cat.name.toLowerCase()}/${sub.name.toLowerCase()}/${uniq.name
                                        .toLowerCase()
                                        .replace(" ", "")}/${uniq.id}`}
                                      key={uniq.id}
                                      style={{
          ...
          <div className="nav_auxiliaryContainer">
            ...
            <Link
              to="/cart"
              className="nav__cartIconContainer"
              style={{
                // backgroundColor: `${
                //   configStore?.colors?.secondaryColorStore || "transparent"
                // }`,
